...
class ViewLocalImagePage extends StatefulWidget {
  ViewLocalImagePage({Key? key, required this.title, required this.imageFile}) : super(key: key);
  String title;
  File imageFile;

  @override
  State<ViewLocalImagePage> createState() => _ViewLocalImagePageState();
}

class _ViewLocalImagePageState extends State<ViewLocalImagePage> with SingleTickerProviderStateMixin{
  late TransformationController controller;
  TapDownDetails? tapDownDetails;
