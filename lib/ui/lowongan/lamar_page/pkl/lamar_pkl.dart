                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    if(isSucces){
                      ...
                      await DataService().sendInbox(widget.companyId.toString(), 'worker', 'Lamaran Baru!', '${workerDetailModel!.data!.username!} baru saja melamar (PKL) di salah satu pekerjaanmu!!');
