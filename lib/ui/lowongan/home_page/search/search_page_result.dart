          ...
          child: Column(
            children: [
              _isLoad ? Center(child: ShimmerJobCard(marginHorizon: 0),) : Padding(
                ...
                child: workerSearchModel!.data!.job!.isEmpty ? Container(
                  height: 600,
                  child: Center(child: Text('Pekerjaan tidak ditemukan'),)
                ) :
                ListView.builder(
                  shrinkWrap: true,
                  physics: const NeverScrollableScrollPhysics(),
                  itemCount: workerSearchModel!.data!.job!.length,
                  itemBuilder: (context, index) {
                    var data = workerSearchModel!.data!.job!;
                    int count;
                      ...
                      onTap: () => Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => JobDetailPage(
                                id: workerSearchModel!.data!.job![index].id!.toInt()),
                          )),
                      child: Column(
                        children: [
                          Container(
