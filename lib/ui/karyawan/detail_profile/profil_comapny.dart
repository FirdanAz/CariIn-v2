...
class _ProfilCompanyPageState extends State<ProfilCompanyPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return _isLoad ? Center(child: CircularProgressIndicator(),) : Scaffold(
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            centerTitle: true,
            systemOverlayStyle: SystemUiOverlayStyle(statusBarColor: color.onPrimaryContainer.withOpacity(0.3)),
            floating: true,
            title: Text(
              'Pengaturan Profil',
              style: TextStyle(
            ...
            actions: [
              Padding(
                ...
                child: InkWell(
                  ...
                  child: CircleAvatar(
                    child: Icon(Icons.logout, color: color.white,),
                    backgroundColor: color.primaryContainer.withOpacity(0.2),
                  )
                ),
              )
            ],
            leading: InkWell(
              ...
              child: Icon(Icons.arrow_back_ios_new, color: color.white,),
            ),
            flexibleSpace: Stack(
              children: [
                SizedBox(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Icon(Icons.edit_note, color: color.white, size: 18,)
                        ],
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.location_on, color: color.white, size: 18,),
                          Text(
