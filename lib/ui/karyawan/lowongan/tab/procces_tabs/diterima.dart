...
class ProccesDiterimaTab extends StatefulWidget {
  const ProccesDiterimaTab({Key? key}) : super(key: key);

  @override
  State<ProccesDiterimaTab> createState() => _ProccesDiterimaTabState();
}

class _ProccesDiterimaTabState extends State<ProccesDiterimaTab> {
  bool _isLoad = false;
