...
class ProccesMenungguTab extends StatefulWidget {
  const ProccesMenungguTab({Key? key}) : super(key: key);

  @override
  State<ProccesMenungguTab> createState() => _ProccesMenungguTabState();
}

class _ProccesMenungguTabState extends State<ProccesMenungguTab> {
  bool _isLoad = false;
  ...
  getdata() async {
    ...
    JobCompanyModel allJob = await ApiService().jobsCompany(false, 'menunggu');
    setState(() {
