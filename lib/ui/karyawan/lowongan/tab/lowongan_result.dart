...
class LowonganResultPage extends StatefulWidget {
  const LowonganResultPage({Key? key}) : super(key: key);

  @override
  State<LowonganResultPage> createState() => _LowonganResultPageState();
}

class _LowonganResultPageState extends State<LowonganResultPage> {
  bool _isLoad = false;
