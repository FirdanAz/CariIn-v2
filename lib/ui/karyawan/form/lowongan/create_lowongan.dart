                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      textFieldEx(
                          title: 'Nama Lowongan',
                          hint: 'Nama Lowongan',
                          editingController: _namaController),
                      textFieldEx(
                          title: 'Alamat Lowongan',
                          hint: 'Jl.Raya Jurang Jakarta',
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Column(
                            children: <Widget>[
                              RadioListTile(
                                title: const Text('Tidak Menerima PKL'),
                                value: false,
                              ...
                              RadioListTile(
                                title: const Text('Menerima PKL', style: TextStyle(color: Colors.green),),
                                value: true,
                                groupValue: _selectedValue,
                                onChanged: (value) {
                                  setState(() {
                              ...
                              // Add more RadioListTile for each option
                            ],
                          ),
                          const SizedBox(
                            height: 10,
