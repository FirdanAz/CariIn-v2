...
class DitolakTabs extends StatefulWidget {
  const DitolakTabs({Key? key}) : super(key: key);

  @override
  State<DitolakTabs> createState() => _DitolakTabsState();
}

class _DitolakTabsState extends State<DitolakTabs> {
  ...
  getdata() async {
    ...
    WorkerApplicationModel allJob = await ApiService().getWorkerResult(false, 'ditolak');
    setState(() {
        ...
        child: Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return InkWell(
                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => DetailPelamarPage(id: data.id!.toInt()),)),
                child: Container(
