...
class _PklDetailPageState extends State<PklDetailPage> {
  ...
  getData() async {
    ...
    PklDetailModel detailModel = await EditService().getDetailPkl(int.parse(widget.id), 'company');
    setState(() {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => CompanyJobDetailPage(id: pklDetailModel!.data!.job!.id!),));
                              },
                              child: SizedBox(
                                width: double.maxFinite,
                                child: Row(
